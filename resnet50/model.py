...
fc_initializer = xavier_initializer
conv2d_initializer = xavier_initializer_conv2d
...
class ResNet50(object):
    ...
    @staticmethod
    def _bottleneck(x, h_out, n_out, stride=None, is_training=True, scope="bottleneck"):
